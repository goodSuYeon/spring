...
public class IocJavaConfig {
	...
	/*
	  메소드 : 스프링 빈으로 만들 객체를 반환하는 메소드를 생성
			 메소드에 @Bean 어노테이션을 적용
			 @Bean 어노테이션에 별다른 옵션을 적용하지 않으면 생성된 스프링 빈의 이름은 -> '메소드이름'으로 적용됨
	*/
	...
	*/
	...
	public UserServiceimpl userService() {
		...
		userService.setUserDao(userDao());  //주입하고 싶은 메소드를 넣어도 됨. 위의 userDao()메소드 
 		return userService;
	}
...
//	@Bean
	public UserServiceimpl userServiceProServiceimpl() {
