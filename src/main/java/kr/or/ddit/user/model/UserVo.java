...
public class UserVo {
	...
	*/
	...
	//인자가 있는 생성자 생성
	/*
	 * public UserVo(String userid, String usernm, String pass) { setUserid(userid);
	 * setUsernm(usernm); setPass(pass); }
	 */
	...
	/*
	 * public Date getHire_dt() { return hire_dt; }
	 * 
	 * public void setHire_dt(Date hire_dt) { this.hire_dt = hire_dt; }
	 * 
	 * 
